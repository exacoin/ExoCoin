...
int64 nChainStartTime = 1375553018;
...
const string strMessageMagic = "ExoCoin Signed Message:\n";
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime)
{
    ...
    if(fTestNet || nTime > PROTOCOL_SWITCH_TIME)
    {
        ...
        // ExoCoin: reward for coin-year is cut in half every 64x multiply of PoS difficulty
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in ExoCoin
    bool fStrictPayToScriptHash = true; // Always active in ExoCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ExoCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
//vMerkleTree: ea6fed5e2
        // Genesis block
        const char* pszTimestamp = "CNN 03/08/2013 'HIDING IN PLAIN SIGHT'";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1375553018;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 73309767;
        ...
        assert(block.hashMerkleRoot == uint256("0xd0bd62cef0875cd27f44408ced9f4274c7a76183727e1847929860c31c8c026a"));
